      ...
      <section id="contact" style={{ textAlign: 'center', marginBottom: '80px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
          <Link href="/mirhadiali" target="_blank" className="glass" style={{
            ...
            <div>
              <p style={{ opacity: 0.6, fontSize: '0.9rem', marginBottom: '4px' }}>LinkedIn</p>
              <p style={{ fontSize: '1.1rem', fontWeight: 600 }}>mirhadiali</p>
            </div>
          </Link>
          ...
          <Link href="https://github.com/mirhadiali" target="_blank" className="glass" style={{
            ...
            <div>
              <p style={{ opacity: 0.6, fontSize: '0.9rem', marginBottom: '4px' }}>GitHub</p>
              <p style={{ fontSize: '1.1rem', fontWeight: 600 }}>mirhadiali</p>
            </div>
          </Link>
        </div>
